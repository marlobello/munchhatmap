...
// Dedicated container for weekly Cosmos DB JSON exports.
resource cosmosBackupsContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-05-01' = {
  parent: blobService
  name: 'cosmos-backups'
  properties: {
    publicAccess: 'None'
...
// Lifecycle policy: tier backup JSON blobs to Cool immediately; delete after 90 days.
